...
const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      <TypingText title="| About Metaversite" textStyles="text-center" />
      <motion.p
      ...
      >
        ...
        the <span className="font-extrabold text-white">madness of the metaverse</span> of today, using only
